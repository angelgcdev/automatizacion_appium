const scrollDown = async (driver) => {
  ...
  try {
    ...
    const startY = height * 0.8; // parte inferior del área
    const endY = height * 0.2; // parte superior del área
    ...
    console.log("❌ Error al hacer scroll hacia abajo:", error.message);
    throw error;
  }
};
